...
subroutine inj_ATL2a(nb,name,mode,nbxvar,nbzvar,nbdata,nbaddpar,prm,parname,nbobs, &
...
!& pwlin4            ! limit active power during undervoltage
      ...
      elseif(x( 10)>=1.5)then
         z( 18)=   3
      elseif(0<=x( 10) .and. x( 10)<0.85)then
         z( 18)=  1
      elseif(0.85<=x( 10) .and. x( 10)<0.88)then
         z( 18)=  2
      elseif(0.88<=x( 10) .and. x( 10)<1.5)then
         z( 18)=  3
      endif
...
!& pwlin4            ! limit active power during undervoltage
      select case (z( 18))
         case (  1)
            f( 88)=prm( 24)+ ( (prm( 24)-prm( 24))*(x( 10)-0)/(0.85-0) ) -x( 31)
         case (  2)
            f( 88)=prm( 24)+ ( (prm( 25)-prm( 24))*(x( 10)-0.85)/(0.88-0.85) ) -x( 31)
         case (  3)
            f( 88)=prm( 25)+ ( (prm( 25)-prm( 25))*(x( 10)-0.88)/(1.5-0.88) ) -x( 31)
      end select
